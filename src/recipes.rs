...
pub(crate) fn dashboards_base(deployment: &Deployment) -> String {
    format!(
        "http://{deployment}-dashboards.{}.svc:5601",
    ...
    match recipe {
        "kubernetes" => vec![
            ...
            viz(
                ...
                "metric",
                metric_params(),
                serde_json::json!([count_agg()]),
                ip,
                None,
            ),
            viz(
                "velox-k8s-active-pods",
                "Active pods",
                "metric",
                metric_params(),
                serde_json::json!([cardinality_agg("kubernetes.pod_name.keyword")]),
                ip,
                None,
            ),
            viz(
                "velox-k8s-errors",
                "Error mentions over time",
                "line",
                line_params(),
                serde_json::json!([count_agg(), datehist_agg()]),
                ip,
                Some("message: error or log: error"),
            ),
            // main trend + distribution
            viz(
                "velox-k8s-timeline",
                "Logs over time by namespace",
                "line",
                line_params(),
                serde_json::json!([
                    count_agg(),
                    datehist_agg(),
                    terms_agg("3", "group", "kubernetes.namespace_name.keyword", 8)
                ]),
                ip,
                None,
            ),
            viz(
                ...
                serde_json::json!([
                    count_agg(),
                    terms_agg("2", "segment", "kubernetes.namespace_name.keyword", 10)
                ]),
                ip,
                None,
            ),
            ...
            viz(
                ...
                "pie",
                pie_params(),
                serde_json::json!([count_agg(), terms_agg("2", "segment", "stream.keyword", 4)]),
                ip,
                None,
            ),
            viz(
                ...
                serde_json::json!([
                    count_agg(),
                    terms_agg("2", "bucket", "kubernetes.pod_name.keyword", 15)
                ]),
                ip,
                None,
            ),
            viz(
                "velox-k8s-containers",
                "Top containers",
                "table",
                table_params(),
                serde_json::json!([
                    count_agg(),
                    terms_agg("2", "bucket", "kubernetes.container_name.keyword", 15)
                ]),
                ip,
                None,
            ),
            viz(
                ...
                serde_json::json!([
                    count_agg(),
                    terms_agg("2", "segment", "kubernetes.host.keyword", 10)
                ]),
                ip,
                None,
            ),
        ...
        "postgres" => vec![
            ...
            viz(
                ...
                "pie",
                pie_params(),
                serde_json::json!([count_agg(), terms_agg("2", "segment", "level", 8)]),
                ip,
                None,
            ),
            viz(
                ...
                serde_json::json!([
                    count_agg(),
                    terms_agg("2", "bucket", "pg_message.keyword", 10)
                ]),
                ip,
                None,
            ),
            viz(
                ...
                serde_json::json!([
                    count_agg(),
                    terms_agg("2", "bucket", "pg_db", 10),
                    terms_agg("3", "bucket", "pg_user", 10)
                ]),
                ip,
                None,
            ),
        ...
        "k8s-events" => vec![
            ...
            viz(
                ...
                serde_json::json!([
                    count_agg(),
                    datehist_agg(),
                    terms_agg("3", "group", "type", 4)
                ]),
                ip,
                None,
            ),
            viz(
                "velox-events-reasons",
                "Reasons",
                "pie",
                pie_params(),
                serde_json::json!([count_agg(), terms_agg("2", "segment", "reason", 12)]),
                ip,
                None,
            ),
            viz(
                ...
                "table",
                table_params(),
                serde_json::json!([count_agg(), terms_agg("2", "bucket", "reason", 15)]),
                ip,
                None,
            ),
            viz(
                ...
                serde_json::json!([
                    count_agg(),
                    terms_agg("2", "bucket", "metadata.namespace", 12)
                ]),
                ip,
                None,
            ),
            viz(
                "velox-events-kinds",
                "Involved object kinds",
                "pie",
                pie_params(),
                serde_json::json!([
                    count_agg(),
                    terms_agg("2", "segment", "involvedObject.kind", 8)
                ]),
                ip,
                None,
            ),
            dashboard_obj(
                "velox-events-overview",
                "Kubernetes Events",
                &[
        ...
        "redis" => vec![
            ...
            viz(
                ...
                "pie",
                pie_params(),
                serde_json::json!([count_agg(), terms_agg("2", "segment", "level_sym", 6)]),
                ip,
                None,
            ),
            viz(
                "velox-redis-messages",
                "Top messages",
                "table",
                table_params(),
                serde_json::json!([
                    count_agg(),
                    terms_agg("2", "bucket", "redis_message.keyword", 10)
                ]),
                ip,
                None,
            ),
            viz(
                ...
                "pie",
                pie_params(),
                serde_json::json!([count_agg(), terms_agg("2", "segment", "role", 6)]),
                ip,
                None,
            ),
            dashboard_obj(
                "velox-redis-overview",
                "Redis Overview",
                &[
        ...
        "mysql" => vec![
            ...
            viz(
                "velox-mysql-subsystems",
                "Subsystems",
                "table",
                table_params(),
                serde_json::json!([count_agg(), terms_agg("2", "bucket", "subsystem", 10)]),
                ip,
                None,
            ),
            viz(
                "velox-mysql-messages",
                "Top messages",
                "table",
                table_params(),
                serde_json::json!([
                    count_agg(),
                    terms_agg("2", "bucket", "mysql_message.keyword", 10)
                ]),
                ip,
                None,
            ),
            dashboard_obj(
                "velox-mysql-overview",
        ...
        "traefik" => vec![
            ...
            viz(
                "velox-traefik-clients",
                "Unique clients",
                "metric",
                metric_params(),
                serde_json::json!([cardinality_agg("clientip")]),
                ip,
                None,
            ),
            viz(
                "velox-traefik-errors",
                "Errors (4xx/5xx) over time",
                "line",
                line_params(),
                serde_json::json!([count_agg(), datehist_agg()]),
                ip,
            ...
            viz(
                ...
                serde_json::json!([
                    count_agg(),
                    datehist_agg(),
                    terms_agg("3", "group", "response", 6)
                ]),
                ip,
                None,
            ),
            viz(
                "velox-traefik-status",
                "Status codes",
                "pie",
                pie_params(),
                serde_json::json!([count_agg(), terms_agg("2", "segment", "response", 10)]),
                ip,
                None,
            ),
            viz(
                "velox-traefik-routers",
                "Top routers",
                "table",
                table_params(),
                serde_json::json!([
                    count_agg(),
                    terms_agg("2", "bucket", "traefik_router.keyword", 10)
                ]),
                ip,
                None,
            ),
            viz(
                ...
                "table",
                table_params(),
                serde_json::json!([count_agg(), terms_agg("2", "bucket", "request", 10)]),
                ip,
                None,
            ),
            viz(
                ...
                "table",
                table_params(),
                serde_json::json!([count_agg(), terms_agg("2", "bucket", "clientip", 10)]),
                ip,
                None,
            ),
            dashboard_obj(
                "velox-traefik-overview",
                "Traefik Overview",
                &[
        ...
        "mongo" => vec![
            ...
            viz(
                "velox-mongo-timeline",
                "Log volume by severity",
                "line",
                line_params(),
                serde_json::json!([count_agg(), datehist_agg(), terms_agg("3", "group", "s", 6)]),
                ip,
                None,
            ),
            viz(
                ...
                "pie",
                pie_params(),
                serde_json::json!([count_agg(), terms_agg("2", "segment", "s", 6)]),
                ip,
                None,
            ),
            viz(
                ...
                "table",
                table_params(),
                serde_json::json!([count_agg(), terms_agg("2", "bucket", "c", 12)]),
                ip,
                None,
            ),
            viz(
                "velox-mongo-messages",
                "Top messages",
                "table",
                table_params(),
                serde_json::json!([count_agg(), terms_agg("2", "bucket", "msg.keyword", 10)]),
                ip,
                None,
            ),
            dashboard_obj(
                "velox-mongo-overview",
                "MongoDB Overview",
                &[
        ...
        "rabbitmq" => vec![
            ...
            viz(
                "velox-rabbitmq-messages",
                "Top messages",
                "table",
                table_params(),
                serde_json::json!([
                    count_agg(),
                    terms_agg("2", "bucket", "rmq_message.keyword", 10)
                ]),
                ip,
                None,
            ),
            dashboard_obj(
                "velox-rabbitmq-overview",
                "RabbitMQ Overview",
                &[
        ...
        "kafka" => vec![
            ...
            viz(
                ...
                "table",
                table_params(),
                serde_json::json!([count_agg(), terms_agg("2", "bucket", "logger", 10)]),
                ip,
                None,
            ),
            viz(
                "velox-kafka-messages",
                "Top messages",
                "table",
                table_params(),
                serde_json::json!([
                    count_agg(),
                    terms_agg("2", "bucket", "kafka_message.keyword", 10)
                ]),
                ip,
                None,
            ),
            dashboard_obj(
                "velox-kafka-overview",
                "Kafka Overview",
                &[
        ...
        "ssh" => vec![
            ...
            viz(
                ...
                "metric",
                metric_params(),
                serde_json::json!([cardinality_agg("src_ip")]),
                ip,
                None,
            ),
            viz(
            ...
            viz(
                ...
                "pie",
                pie_params(),
                serde_json::json!([count_agg(), terms_agg("2", "segment", "auth_result", 6)]),
                ip,
                None,
            ),
            viz(
                ...
                "table",
                table_params(),
                serde_json::json!([count_agg(), terms_agg("2", "bucket", "src_ip", 15)]),
                ip,
                None,
            ),
            viz(
                ...
                "table",
                table_params(),
                serde_json::json!([count_agg(), terms_agg("2", "bucket", "auth_user", 15)]),
                ip,
                None,
            ),
            viz(
                ...
                "pie",
                pie_params(),
                serde_json::json!([count_agg(), terms_agg("2", "segment", "auth_method", 6)]),
                ip,
                None,
            ),
            dashboard_obj(
        ...
        "k8s-audit" => vec![
            ...
            viz(
                "velox-k8s-audit-denied",
                "Denied / errors over time",
                "line",
                line_params(),
                serde_json::json!([count_agg(), datehist_agg()]),
                ip,
            ...
            viz(
                "velox-k8s-audit-verbs",
                "Verbs",
                "pie",
                pie_params(),
                serde_json::json!([count_agg(), terms_agg("2", "segment", "verb", 10)]),
                ip,
                None,
            ),
            viz(
                "velox-k8s-audit-users",
                "Top users",
                "table",
                table_params(),
                serde_json::json!([count_agg(), terms_agg("2", "bucket", "user.username", 15)]),
                ip,
                None,
            ),
            viz(
                "velox-k8s-audit-resources",
                "Top resources",
                "table",
                table_params(),
                serde_json::json!([
                    count_agg(),
                    terms_agg("2", "bucket", "objectRef.resource", 15)
                ]),
                ip,
                None,
            ),
            viz(
                ...
                "table",
                table_params(),
                serde_json::json!([count_agg(), terms_agg("2", "bucket", "sourceIPs", 15)]),
                ip,
                None,
            ),
            viz(
                "velox-k8s-audit-codes",
                "Response codes",
                "pie",
                pie_params(),
                serde_json::json!([
                    count_agg(),
                    terms_agg("2", "segment", "responseStatus.code", 8)
                ]),
                ip,
                None,
            ),
            dashboard_obj(
                "velox-k8s-audit-overview",
                "Kubernetes Audit",
                &[
        ...
        _ => vec![
            ...
            viz(
                "velox-nginx-bytes",
                "Traffic (bytes) over time",
                "line",
                line_params(),
                serde_json::json!([sum_agg("bytes"), datehist_agg()]),
                ip,
                None,
            ),
            viz(
            ...
            viz(
                ...
                "table",
                table_params(),
                serde_json::json!([count_agg(), terms_agg("2", "bucket", "agent.keyword", 10)]),
                ip,
                None,
            ),
            dashboard_obj(
...
pub(crate) async fn ensure_index_pattern(
    ...
    let mut req = c
        .post(format!(
            "{dash}/api/saved_objects/index-pattern/{id}?overwrite=true"
        ))
        .basic_auth(&u, Some(&p))
        .header("osd-xsrf", "true");
    if let Some(t) = tenant_scope(deployment).await {
...
mod tests {
    ...
    fn dashboard_objects_are_self_consistent() {
        for r in RECIPES {
            ...
            assert_eq!(
                dash["type"], "dashboard",
                "{r}: last object not a dashboard"
            );
            assert_eq!(dash["id"], dashboard_id(r), "{r}: dashboard id mismatch");

            let viz_ids: HashSet<&str> = vizzes.iter().map(|v| v["id"].as_str().unwrap()).collect();
