...
docker save docker.io/tornistecnologia/veloxsearch-oss:0.10.0 -o veloxsearch.tar
...
| `releases/download/v0.10.0/install.yaml` | The same, pinned to one version instead of following the newest |
...
```bash
cosign verify docker.io/tornistecnologia/veloxsearch-oss:0.10.0 \
